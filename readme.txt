...
Before opening an Issue, check https://github.com/riderkick/FMD/wiki/FAQ page. Also, searching will help FMD developers. You can do it by opening https://github.com/riderkick/FMD/issues page and writing your problem at the "Filters" section. For example, you have a problem with A site, writing A at the end of that field will filter Issues. This will lower Open Issues a little.

5.) Websites Wiki

There is a wiki page, https://github.com/riderkick/FMD/wiki/Websites. Check it before opening an issue. It states that whether a website is noted as "Broken", "Ok" or "Removed". It may not be up-to-date, but doing this also helps developers and lowers their workload.
---------------------------------
