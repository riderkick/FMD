...
After everything is installed, open the file md.lpr by using Lazarus IDE, select Run->Build tto build the source code. If everything is ok, the binary file should be in FMD_source_code_folder/trunk/bin
