...
local DirectoryPagination = '/manga-list/page-'
...
function GetInfo()
  ...
  --[[Debug]] LuaDebug.WriteLogWithHeader('GetInfo', 'pages ->  ' .. pages)
  local p = 1
  while true do
    --[[Debug]] LuaDebug.WriteLogWithHeader('GetInfo', 'url ->  ' .. u .. '/page-' .. tostring(p))
