...
function getTitle(x)
	...
	if title == '' then title = x.xpathstring('//*[@class="title"]/h2') end
	title = title:gsub('Bahasa Indonesia$', ''):gsub(' Indonesia|Baca"', ''):gsub('Bahasa Indonesia', ''):gsub('Komik', '')
	title = title:gsub('Manga', ''):gsub('Indonesia', ''):gsub('Baca', '')
	return title
end
...
function getGenres(x)
	local genre = ''
	if genre == '' then genre = x.xpathstring('//div[@class="spe"]//span[starts-with(.,"Genres:")]/substring-after(.,":")') end
	if genre == '' then genre = x.xpathstring('//div[contains(@class,"animeinfo")]/div[@class="gnr"]/a') end
	if genre == '' then genre = x.xpathstring('//div[@class="gnr"]/a') end
	if genre == '' then genre = x.xpathstring('//div[contains(@class,"mrgn animeinfo")]/div[@class="gnr"]/a') end
	if genre == '' then genre = x.xpathstring('//span[@id="m-genre"]') end
	if genre == '' then genre = x.xpathstring('//table[@class="listinfo"]//tr[contains(th, "Genre")]/td/a') end
	if genre == '' then genre = x.xpathstring('//table[@class="attr"]//tr[contains(th, "Genres")]/td/a') end
	if genre == '' then genre = x.xpathstring('//div[@class="spe"]//span[starts-with(.,"Genre")]/a') end
	if genre == '' then genre = x.xpathstring('//div[@class="spe"]//span[starts-with(.,"Genres")]/a') end
	if genre == '' then genre = x.xpathstring('//div[@class="genrex"]/a') end
	if genre == '' then genre = x.xpathstring('//ul[@class="genre"]/li') end
	if genre == '' then genre = x.xpathstring('//span[@class="details"]//div[starts-with(.,"Genre")]/a') end
	if genre == '' then genre = x.xpathstring('//div[@class="listinfo"]//li[starts-with(.,"Genre")]/substring-after(.,":")') end
	return genre
end
...
function getSummary(x)
	...
	if summary == '' then summary = x.xpathstring('//*[@class="description"]/text()') end
	return summary
end
...
local cat = 'Indonesian'
	...
	AddWebsiteModule('MangaKita', 'https://www.mangakita.net', cat)
