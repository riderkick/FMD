...
const
  ...
  KOMIKID_ID             = 14;
  ESMANGAHERE_ID         = 15;
  ANIMEEXTREMIST_ID      = 16;
  HUGEMANGA_ID           = 17;
  S2SCAN_ID              = 18;
  IMANHUA_ID             = 19;
  MABUNS_ID              = 20;
  MANGAESTA_ID           = 21;
  CENTRALDEMANGAS_ID     = 22;
  EGSCANS_ID             = 23;
  MANGAAR_ID             = 24;
  MANGAAE_ID             = 25;
  ANIMESTORY_ID          = 26;
  LECTUREENLIGNE_ID      = 27;
  SCANMANGA_ID           = 28;
  MANGAGO_ID             = 29;
  DM5_ID                 = 30;
  MANGACOW_ID            = 31;
  ...
  JAPANSHIN_ID           = 43;
  JAPSCAN_ID             = 44;
  CENTRUMMANGI_PL_ID     = 45;
  MANGALIB_PL_ID         = 46;
  ONEMANGA_ID            = 47;
  MANGATOWN_ID           = 48;
  MANGAOKU_ID            = 49;
  MYREADINGMANGAINFO_ID  = 50;
  IKOMIK_ID              = 51;
  NHENTAI_ID             = 52;
  MANGAMINT_ID           = 53;
  UNIXMANGA_ID           = 54;
  ...
  MANGAKU_ID             = 65;
  MANGAAT_ID             = 66;
  READMANGATODAY_ID      = 67;
  DYNASTYSCANS_ID        = 68;

  WebsiteRoots: array [0..68] of array [0..1] of String = (
