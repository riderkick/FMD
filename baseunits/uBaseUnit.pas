...
const
  ...
  MABUNS_ID              = 31;
  MANGAESTA_ID           = 32;
  CENTRALDEMANGAS_ID     = 33;
  EGSCANS_ID             = 34;
  MANGAAR_ID             = 35;
  MANGAAE_ID             = 36;
  ANIMESTORY_ID          = 37;
  LECTUREENLIGNE_ID      = 38;
  SCANMANGA_ID           = 39;
  MANGAGO_ID             = 40;
  DM5_ID                 = 41;
  PURURIN_ID             = 42;
  ...
  JAPANSHIN_ID           = 57;
  JAPSCAN_ID             = 58;
  CENTRUMMANGI_PL_ID     = 59;
  MANGALIB_PL_ID         = 60;
  ONEMANGA_ID            = 61;
  MANGATOWN_ID           = 62;
  READHENTAIMANGA_ID     = 63;
  MANGAOKU_ID            = 64;
  MYREADINGMANGAINFO_ID  = 65;
  IKOMIK_ID              = 66;
  NHENTAI_ID             = 67;
  UNIONMANGAS_ID         = 68;
  MANGAMINT_ID           = 69;
