...
const
  ...
  MABUNS_ID              = 36;
  MANGAESTA_ID           = 37;
  CENTRALDEMANGAS_ID     = 38;
  EGSCANS_ID             = 39;
  MANGAAR_ID             = 40;
  MANGAAE_ID             = 41;
  ANIMESTORY_ID          = 42;
  LECTUREENLIGNE_ID      = 43;
  SCANMANGA_ID           = 44;
  MANGAGO_ID             = 45;
  DM5_ID                 = 46;
  PURURIN_ID             = 47;
  ...
  JAPANSHIN_ID           = 63;
  JAPSCAN_ID             = 64;
  CENTRUMMANGI_PL_ID     = 65;
  MANGALIB_PL_ID         = 66;
  ONEMANGA_ID            = 67;
  MANGATOWN_ID           = 68;
  READHENTAIMANGA_ID     = 69;
  MANGAOKU_ID            = 70;
  MYREADINGMANGAINFO_ID  = 71;
  IKOMIK_ID              = 72;
  NHENTAI_ID             = 73;
  UNIONMANGAS_ID         = 74;
  MANGAMINT_ID           = 75;
