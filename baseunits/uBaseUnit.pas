...
const
  ...
  MABUNS_ID              = 35;
  MANGAESTA_ID           = 36;
  CENTRALDEMANGAS_ID     = 37;
  EGSCANS_ID             = 38;
  MANGAAR_ID             = 39;
  MANGAAE_ID             = 40;
  ANIMESTORY_ID          = 41;
  LECTUREENLIGNE_ID      = 42;
  SCANMANGA_ID           = 43;
  MANGAGO_ID             = 44;
  DM5_ID                 = 45;
  PURURIN_ID             = 46;
  ...
  JAPANSHIN_ID           = 61;
  JAPSCAN_ID             = 62;
  CENTRUMMANGI_PL_ID     = 63;
  MANGALIB_PL_ID         = 64;
  ONEMANGA_ID            = 65;
  MANGATOWN_ID           = 66;
  READHENTAIMANGA_ID     = 67;
  MANGAOKU_ID            = 68;
  MYREADINGMANGAINFO_ID  = 69;
  IKOMIK_ID              = 70;
  NHENTAI_ID             = 71;
  UNIONMANGAS_ID         = 72;
  MANGAMINT_ID           = 73;
