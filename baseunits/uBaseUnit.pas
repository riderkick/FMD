...
const
  ...
  KOMIKID_ID             = 16;
  ESMANGAHERE_ID         = 17;
  ANIMEEXTREMIST_ID      = 18;
  HUGEMANGA_ID           = 19;
  S2SCAN_ID              = 20;
  IMANHUA_ID             = 21;
  MABUNS_ID              = 22;
  MANGAESTA_ID           = 23;
  CENTRALDEMANGAS_ID     = 24;
  EGSCANS_ID             = 25;
  MANGAAR_ID             = 26;
  MANGAAE_ID             = 27;
  ANIMESTORY_ID          = 28;
  LECTUREENLIGNE_ID      = 29;
  SCANMANGA_ID           = 30;
  MANGAGO_ID             = 31;
  DM5_ID                 = 32;
  MANGACOW_ID            = 33;
  ...
  JAPANSHIN_ID           = 45;
  JAPSCAN_ID             = 46;
  CENTRUMMANGI_PL_ID     = 47;
  MANGALIB_PL_ID         = 48;
  ONEMANGA_ID            = 49;
  MANGATOWN_ID           = 50;
  MANGAOKU_ID            = 51;
  MYREADINGMANGAINFO_ID  = 52;
  IKOMIK_ID              = 53;
  NHENTAI_ID             = 54;
  MANGAMINT_ID           = 55;
  UNIXMANGA_ID           = 56;
  ...
  MANGAKU_ID             = 67;
  MANGAAT_ID             = 68;
  READMANGATODAY_ID      = 69;
  DYNASTYSCANS_ID        = 70;

  WebsiteRoots: array [0..70] of array [0..1] of String = (
