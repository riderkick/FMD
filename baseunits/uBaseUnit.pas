...
const
  ...
  MABUNS_ID              = 28;
  MANGAESTA_ID           = 29;
  CENTRALDEMANGAS_ID     = 30;
  EGSCANS_ID             = 31;
  MANGAAR_ID             = 32;
  MANGAAE_ID             = 33;
  ANIMESTORY_ID          = 34;
  LECTUREENLIGNE_ID      = 35;
  SCANMANGA_ID           = 36;
  MANGAGO_ID             = 37;
  DM5_ID                 = 38;
  MANGACOW_ID            = 39;
  ...
  JAPANSHIN_ID           = 51;
  JAPSCAN_ID             = 52;
  CENTRUMMANGI_PL_ID     = 53;
  MANGALIB_PL_ID         = 54;
  ONEMANGA_ID            = 55;
  MANGATOWN_ID           = 56;
  MANGAOKU_ID            = 57;
  MYREADINGMANGAINFO_ID  = 58;
  IKOMIK_ID              = 59;
  NHENTAI_ID             = 60;
  MANGAMINT_ID           = 61;
  UNIXMANGA_ID           = 62;
  ...
  ACADEMYVN_ID           = 75;
  MANGAAT_ID             = 76;
  READMANGATODAY_ID      = 77;
  LONEMANGA_ID           = 78;
  DYNASTYSCANS_ID        = 79;

  WebsiteRoots: array [0..79] of array [0..1] of string = (
