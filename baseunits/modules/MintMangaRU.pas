    ...
    if GET(FillHost(Module.RootURL,AURL)) then begin
      ...
      with TXQueryEngineHTML.Create(Document) do
        try
          ...
          authors:=Trim(SeparateRight(XPathString('//*[starts-with(@class,"subject-meta")]/*[starts-with(.,"Автор")]'),':'));
          genres:=Trim(SeparateRight(XPathString('//*[starts-with(@class,"subject-meta")]/*[starts-with(.,"Категория")]'),':'));
